...
Además, redacta un correo de seguimiento breve y personalizado para enviarle directamente al prospecto (a él, no es para uso interno). Debe sonar humano y cálido, mencionar algo específico y real de su empresa o de su mensaje (no genérico), y motivarlo a agendar la demo. 2-3 frases, sin saludo ni despedida (esos se agregan aparte).

Responde ÚNICAMENTE con un objeto JSON, sin texto adicional ni markdown, con este formato exacto:
{
  "score": <entero 1-100>,
  "priority": "Alta" | "Media" | "Baja",
  "reasoning": "<explicación breve en español, 2-3 frases, para uso interno del equipo de ventas>",
  "signals": {
    "b2b": true | false,
    "high_budget": true | false,
    "company_size": "pequeña" | "mediana" | "grande" | "desconocida"
  },
  "emailMessage": "<párrafo personalizado en español para enviar directamente al prospecto>"
}`;
}
